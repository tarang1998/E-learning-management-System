...
import 'package:elmsflutterapp/app/register-courses/presentation/registerCourseView.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: IndexedStack(
          ...
          children: <Widget>[
            if (initState.page == 0) DashboardPage(),
            if (initState.page == 1) RegisterCoursePage(),
          ],
        ),
      ),
    );
